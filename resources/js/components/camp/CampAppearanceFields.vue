    ...
    <div class="grid gap-4">
        <div class="flex items-center gap-3">
            ...
            <div
                ...
                :class="colorStyle(color).chip"
            >
                <component :is="campIcon(icon)" class="size-6" />
            </div>
            <div class="grid gap-1">
                <Label>{{ t('camps.appearance.color') }}</Label>
        ...
        <div class="grid gap-1.5">
            <Label>{{ t('camps.appearance.icon') }}</Label>
        ...
        <div class="grid gap-2">
            <Label for="camp-location">{{
                t('camps.appearance.location')
            }}</Label>
            <Input
                id="camp-location"
                v-model="location"
                :placeholder="t('camps.appearance.locationPlaceholder')"
            />
        </div>
    </div>
</template>
